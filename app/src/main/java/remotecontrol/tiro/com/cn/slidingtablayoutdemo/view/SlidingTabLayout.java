package remotecontrol.tiro.com.cn.slidingtablayoutdemo.view;
...
import remotecontrol.tiro.com.cn.slidingtablayoutdemo.R;
...
public class SlidingTabLayout extends TabLayout {
    ...
    public SlidingTabLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mSlideIcon = BitmapFactory.decodeResource(getResources(), R.mipmap.line_icon);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        canvas.drawBitmap(this.mSlideIcon, 0, 2, null);
        canvas.restore();
